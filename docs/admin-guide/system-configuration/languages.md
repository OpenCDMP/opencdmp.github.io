...
Editing and removing existing languages is also possible by clicking on the three dots available on the last column.
...
- **Ordinal**: This controls the position in which the language will appear on all the dropdowns with the available languages.
