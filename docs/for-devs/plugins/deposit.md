...
3. **Use Existing Implementations as Examples**:
   - You can refer to the [repository-deposit-zenodo](https://github.com/OpenCDMP/repository-deposit-zenodo) project that is part of the OpenCDMP platform (*is mentioned in [supplementary services section](/docs/supplementary-services/deposit-services.md)*) as examples.

5. **Register the Service**:
   - Once your service is implemented and running, register it with the OpenCDMP platform (*for more details see **[Tenant Configuration](/docs/administration/tenant-configuration.md)***). It will then be available as a repository deposit option for plans.
