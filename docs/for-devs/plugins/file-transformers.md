...
3. **Use Existing Implementations as Examples**:
   - You can refer to the [file-transformer-docx](https://github.com/OpenCDMP/file-transformer-docx) and [file-transformer-rda-json](https://github.com/OpenCDMP/file-transformer-rda-json) projects that are part of the OpenCDMP platform (*are mentioned in [supplementary services section](/docs/supplementary-services/file-transformers.md)*) as examples.

4. **Register the Service**:
   - Once your service is implemented and running, register it with the OpenCDMP platform (*for more details see **[Tenant Configuration](/docs/administration/tenant-configuration.md)***). It will appear as an available option for import/export within the platform.
