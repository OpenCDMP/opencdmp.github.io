...
:::info
The way we create a annotation status is described in detail in the [annotation statuses](/docs/administration/annotation-statuses.md) section of the docs.
:::
