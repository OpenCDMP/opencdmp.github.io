...
The way we configure a new reference is described in detail in the [reference types administration](admin-guide/system-configuration/reference-types.md) section of the docs.
