...
On this page, users can provide their own credentials if they prefer not to use the default configuration. This allows greater flexibility when connecting to external services. Click [here](optional-services/deposit-services.md) to view the list of available deposit services.
 
:::note
Only supported deposit services will be shown. If there are any available plugins related to deposit services, they will also be displayed.
:::
