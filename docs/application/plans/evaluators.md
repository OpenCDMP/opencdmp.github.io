...
You can evaluate a plan from [evaluator services](/docs/supplementary-services/evaluator-services.md) after pressing `EVALUATE` and select evaluation type. One type of evaluation is:
...
:::info
- Evaluation feature is available only in [`Plan Overview`](/docs/application/plans/plan-overview.md)
- You can use the evaluation feature if current plan status has this action. More details can be found [here](/docs/administration/plan-statuses.md)
:::
