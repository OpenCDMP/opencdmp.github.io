...
:::info
Notification Templates describe how a notification is structured. There are default templates in [notification service](/docs/supplementary-services/notifications/index.md) but in this page you can create your own.
:::
