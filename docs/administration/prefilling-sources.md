...
In this page, there is a listing where you can view details about all the configured prefilling sources. 

:::info
**Prefilling sources** are data sources coming outside of the platform, in order to help the user with filling out a [description](/docs/application/descriptions/index.md) form with some basic information.
:::
...
- **Label**: The label of this prefillinf source.
...
- **Semantic Target**: Please refer to the [semantics](/docs/administration/blueprints/semantics.md) section.
